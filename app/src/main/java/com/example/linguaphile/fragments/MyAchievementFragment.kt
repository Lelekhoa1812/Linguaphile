...
//            Achievement(4, "Enthusiast IV", "Logged in for 90 days", if (vocabularyViewModel.getDaysLoggedIn() >= 90) R.drawable.yes else R.drawable.no),
            ...
            Achievement(5, "Studious Bee I", "Added 10 vocabs", if (totalVocab >= 10) R.drawable.yes else R.drawable.no),
            Achievement(6, "Studious Bee II", "Added 100 vocabs", if (totalVocab >= 100) R.drawable.yes else R.drawable.no),
            Achievement(7, "Studious Bee III", "Added 200 vocabs", if (totalVocab >= 200) R.drawable.yes else R.drawable.no),
            Achievement(8, "Studious Bee IV", "Added 500 vocabs", if (totalVocab >= 500) R.drawable.yes else R.drawable.no),
            Achievement(9, "Studious Bee V", "Added 1000 vocabs", if (totalVocab >= 1000) R.drawable.yes else R.drawable.no),

            // Noun Expert Achievements
            Achievement(10, "Noun Expert I", "Added 10 nouns", if (totalNouns >= 10) R.drawable.yes else R.drawable.no),
            Achievement(11, "Noun Expert II", "Added 50 nouns", if (totalNouns >= 50) R.drawable.yes else R.drawable.no),
            Achievement(12, "Noun Expert III", "Added 100 nouns", if (totalNouns >= 100) R.drawable.yes else R.drawable.no),
            Achievement(13, "Noun Expert IV", "Added 200 nouns", if (totalNouns >= 200) R.drawable.yes else R.drawable.no),
            Achievement(14, "Noun Expert V", "Added 500 nouns", if (totalNouns >= 500) R.drawable.yes else R.drawable.no),

            // Verb Expert Achievements
            Achievement(15, "Verb Expert I", "Added 10 verbs", if (totalVerbs >= 10) R.drawable.yes else R.drawable.no),
            Achievement(16, "Verb Expert II", "Added 50 verbs", if (totalVerbs >= 50) R.drawable.yes else R.drawable.no),
            Achievement(17, "Verb Expert III", "Added 100 verbs", if (totalVerbs >= 100) R.drawable.yes else R.drawable.no),
            Achievement(18, "Verb Expert IV", "Added 200 verbs", if (totalVerbs >= 200) R.drawable.yes else R.drawable.no),
            Achievement(19, "Verb Expert V", "Added 500 verbs", if (totalVerbs >= 500) R.drawable.yes else R.drawable.no),

            // Adjective Expert Achievements
            Achievement(20, "Adjective Expert I", "Added 10 adjectives", if (totalAdjectives >= 10) R.drawable.yes else R.drawable.no),
            Achievement(21, "Adjective Expert II", "Added 50 adjectives", if (totalAdjectives >= 50) R.drawable.yes else R.drawable.no),
            Achievement(22, "Adjective Expert III", "Added 100 adjectives", if (totalAdjectives >= 100) R.drawable.yes else R.drawable.no),
            Achievement(23, "Adjective Expert IV", "Added 200 adjectives", if (totalAdjectives >= 200) R.drawable.yes else R.drawable.no),
            Achievement(24, "Adjective Expert V", "Added 500 adjectives", if (totalAdjectives >= 500) R.drawable.yes else R.drawable.no),

            // Adverb Expert Achievements
            Achievement(25, "Adverb Expert I", "Added 10 adverbs", if (totalAdverbs >= 10) R.drawable.yes else R.drawable.no),
            Achievement(26, "Adverb Expert II", "Added 50 adverbs", if (totalAdverbs >= 50) R.drawable.yes else R.drawable.no),
            Achievement(27, "Adverb Expert III", "Added 100 adverbs", if (totalAdverbs >= 100) R.drawable.yes else R.drawable.no),
            Achievement(28, "Adverb Expert IV", "Added 200 adverbs", if (totalAdverbs >= 200) R.drawable.yes else R.drawable.no),
            Achievement(29, "Adverb Expert V", "Added 500 adverbs", if (totalAdverbs >= 500) R.drawable.yes else R.drawable.no),
